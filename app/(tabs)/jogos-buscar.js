      ...
      <ScrollView contentContainerStyle={styles.conteudo}>
        ...
        {jogos && (
          <View style={styles.card}>
            <Image source={{ uri: jogos.imageUrl }} style={styles.imagem} />

            <View style={styles.info}>
              <Text style={styles.titulo}>{jogos.title}</Text>

              <Text style={styles.categoria}>
                {jogos.genero} · {jogos.plataforma}
              </Text>

              <Text style={styles.ano}>Ano de lançamento: {jogos.ano_lancamento}</Text>
            </View>
          </View>
        )}
      </ScrollView>
